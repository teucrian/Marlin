 ...
 */
#define E0_AUTO_FAN_PIN PB15           // FAN2 in SKR Mini E3V3
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT_HOME  580  // (mA) RMS current for homing. (Typically lower than *_CURRENT.)
